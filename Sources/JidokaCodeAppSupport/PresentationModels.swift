...
public enum JidokaAccessibilityID {
  ...
  public static let rolloutStop = "jidoka.menu.rollout-stop"
  public static let rolloutRecovery = "jidoka.menu.rollout-recovery"
  ...
  public static let rolloutInput = "jidoka.rollout.input"
  public static let rolloutProposalReference = "jidoka.rollout.proposal-reference"
  public static let rolloutProposalNumber = "jidoka.rollout.proposal-number"
  public static let rolloutPropose = "jidoka.rollout.propose"
  public static let rolloutPreview = "jidoka.rollout.preview"
  public static let rolloutCanonical = "jidoka.rollout.canonical"
  public static let rolloutConfirmation = "jidoka.rollout.confirmation"
  public static let rolloutActivate = "jidoka.rollout.activate"
