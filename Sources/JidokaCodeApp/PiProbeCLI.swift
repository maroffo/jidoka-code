...
private enum PiProbeCLIConstants {
  ...
  static let runnerSHA256 = "748a14b739a910fa5318819ed5a9391ef0b0f0a13fb028f942477bc373976679"
...
enum PiProbeCLI {
  ...
  private static func packagedRunner(in resourceRoot: URL) throws -> URL {
    let runner = resourceRoot.appendingPathComponent(
      PiProbeCLIConstants.runnerRelativePath,
      isDirectory: false
    ).standardizedFileURL
    ...
    guard digest == PiProbeCLIConstants.runnerSHA256
    else {
      throw PiProbeCLIError.invalidPackagedRunner
    }
    return runner
