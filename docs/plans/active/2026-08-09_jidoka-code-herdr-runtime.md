...
- [x] 2026-08-12: W8 usa `com.maroffo.JidokaCode` e `com.maroffo.JidokaCode.Engine`; il merge product-bearing exact `c218e52…` è riprodotto senza patch in staging disposable, notarizzato `Accepted`, copiato fuori staging e provato da cwd `/` dopo la rimozione del checkout. Package finale `94382d030a09e796b06d8cc8d79403b98f5cc0d384ca6c6366f4afea49b72366`; installazione assente. S9 automatico resta statico e il launch production resta live-only. Evidence: [`docs/evidence/w8-production-identifier-staging-report.md`](../../evidence/w8-production-identifier-staging-report.md).
...
Gli identifier production, lo staging disposable del merge finale e la notarization del package `94382d03…` sono chiusi nel piano W8; lo staging signed precedente resta evidence storica superseded. Restano CHECKPOINT C, installazione, ServiceManagement, runtime accessibility, credential GitHub/provider e canary sulla sessione default. Ognuno richiede il checkpoint specifico già definito.
