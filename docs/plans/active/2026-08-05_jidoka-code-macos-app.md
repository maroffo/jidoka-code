...
- [x] Ripetere package build dal tree finale in un disposable staging checkout creato per il test, registrare il target e rimuovere soltanto quel path dopo build. Il bundle deve poi avviarsi con cwd `/`; il normale implementation worktree non viene spostato o nascosto. Il merge product-bearing `c218e52…` è stato riprodotto senza patch, notarizzato `Accepted`, copiato fuori staging, poi provato da cwd `/` solo dopo la rimozione del checkout. Package SHA-256 `94382d030a09e796b06d8cc8d79403b98f5cc0d384ca6c6366f4afea49b72366`.
...
- [ ] W8 packaging, installer, documentation and repository gates. Identifier production, gate non-macOS, disposable staging dal tree finale e notarization sono chiusi; restano CHECKPOINT C, installazione e verifica installed.
