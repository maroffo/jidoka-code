...
- [ ] W8 packaging, installer, documentation and repository gates. Identifier production e gate non-macOS sono chiusi; restano disposable staging dal tree finale, final notarization, CHECKPOINT C, installazione e verifica installed.
