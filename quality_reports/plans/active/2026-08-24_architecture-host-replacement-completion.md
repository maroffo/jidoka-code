...
- Later execution completed the source, secure nested install-path, protocol-11 onboarding/Keychain handoff, serialized quit, Herdr session privacy, release-owned runtime, generation-rollover, exact q4, terminal-theme import, and commit-narrative work. Source commits `e22c32a191892425fefaae9549e4d14207ae1062` and `c67943130e535da65274b77601e36241ce781454` merged through PR `#16` as `b6cb62ba7d53d5de740d6e2983656f911db7bd1c`.
- The ninth candidate was installed at the secure nested path and passed two authoritative Paused lifecycle cycles plus the four-role sandbox PR canary. Its final evidence inventory SHA-256 is `21ed3ff062481dfc16d8b7b4e6137c18e6ea3f488cbb640a375bcf4e06595644`.
- That installed candidate is intentionally unnotarized and Gatekeeper-rejected, so it is behavioral qualification, not the final production distribution. The old W8/W9 checklist and package hashes do not authorize or identify the next release.
- Current operational planning is `quality_reports/plans/active/2026-09-03_progressive-production-automation.md`. It binds future work to the merged source, a new notarized package, schema-10 rollout authority, and progressive review/triage/implementation gates. Historical blocked jobs, runs, sessions, descriptors, intents, and evidence remain untouched.
