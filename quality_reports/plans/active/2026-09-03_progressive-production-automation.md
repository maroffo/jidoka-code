...
- [ ] W0-W6 source implementation, verification, review, and source PR
  ...
  - Next action: finish the fresh gate set, commit, push `feat/progressive-production-automation`, and post the round-3 PR disposition, including the correction that the published "3 of 8 fail" lease-gate mutation number is wrong: the real number is 2 of 8 (the test reviewer measured four mutants killing 7 of 8). Then a fresh review of the resulting commit before any claim of source completion. Merge and W7 remain Max's gates and are untouched.
