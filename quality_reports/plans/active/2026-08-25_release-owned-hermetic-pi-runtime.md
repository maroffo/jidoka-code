...
- This plan's runtime architecture remains normative historical evidence: production resolves release-owned Node `26.7.0`, Pi `0.84.2`, manifest SHA-256 `fe15573a58a4604a3695b092ba8b07ae2432da7b7f07743a8d54a4421ab3aa83`, and signed Pi tree `534e4aa6ca73afbf31c48fc0c666978e3ab0114e7c1952f08ddae5139a9e9e37`. The source merged through PR `#16` at `b6cb62ba7d53d5de740d6e2983656f911db7bd1c`.
- Later installation used the secure nested path under `/Library/Application Support/JidokaCode`, not the rejected standard `/Applications` path. The installed ninth candidate proved runtime behavior and the four-role PR canary, but it is intentionally unnotarized and cannot be promoted as the final release artifact.
- The accepted trusted-repository/trusted-command process-containment boundary remains unchanged. No later plan may describe it as hostile child containment without new evidence and approval.
- Current operational planning is `quality_reports/plans/active/2026-09-03_progressive-production-automation.md`. It requires a clean merged-tree rebuild, new notarization/stapling/Gatekeeper evidence, and schema-10 progressive authority before real review, triage, or implementation automation. Unchecked operational implications above grant no action.
