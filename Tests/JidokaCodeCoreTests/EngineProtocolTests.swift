...
struct EngineProtocolTests {
  ...
  func codableCommands() throws {
    ...
    let rollout = try engineRolloutProtocolFixture()
...
private struct EngineRolloutProtocolFixture {
  ...
  let recoveryRequest: RolloutRecoveryRequest
  let recoveryAuthorization: RolloutRecoveryAuthorization
}

private func engineRolloutProtocolFixture() throws -> EngineRolloutProtocolFixture {
  ...
  return EngineRolloutProtocolFixture(
